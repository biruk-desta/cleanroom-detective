...
\hypersetup{colorlinks=true,urlcolor=teal,linkcolor=teal,pdftitle={Cleanroom Detective: A Visual Project Explainer},pdfauthor={TAPIA Hackathon Project Planning}}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\bfseries\color{teal} CLEANROOM DETECTIVE}
...
Cleanroom Detective investigates the problems, repairs what the evidence supports,
...
\node[anchor=west,text=white,font=\large\bfseries] at (0.4,8.98) {Cleanroom Detective};
